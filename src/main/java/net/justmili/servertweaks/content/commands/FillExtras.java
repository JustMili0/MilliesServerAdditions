                    ...
                    .then(Commands.argument("block", BlockStateArgument.block(commandBuildContext))
                        .then(Commands.literal("destroyOnly")
                            .then(Commands.argument("target", BlockStateArgument.block(commandBuildContext))
                                .executes(context -> {
                                    ...
                                    var from = BlockPosArgument.getLoadedBlockPos(context, "from");
                                    var to = BlockPosArgument.getLoadedBlockPos(context, "to");
                                    var replaceWith = BlockStateArgument.getBlock(context, "block").getState();
                                    var targetBlock = BlockStateArgument.getBlock(context, "target").getState();
                        ...
                        .then(Commands.literal("silkDestroy")
                            .executes(context -> {
                                ...
                                var to = BlockPosArgument.getLoadedBlockPos(context, "to");
                                var replaceWith = BlockStateArgument.getBlock(context, "block").getState();
                                var silkTool = makeSilkTouchTool(level);
                        ...
                        .then(Commands.literal("fortuneDestroy")
                            .then(Commands.argument("fortuneLevel", IntegerArgumentType.integer(1, 3))
                                .executes(context -> {
                                    ...
                                    var fortuneTool = makeFortuneTool(level, fortuneLevel);
