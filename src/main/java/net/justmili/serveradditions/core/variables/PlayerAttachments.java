package net.justmili.serveradditions.core.variables;

import com.mojang.serialization.Codec;
import net.fabricmc.fabric.api.attachment.v1.AttachmentType;
import net.justmili.serveradditions.config.Config;

import static net.justmili.serveradditions.core.util.FdaApiUtil.createPersistentValue;
import static net.justmili.serveradditions.core.util.FdaApiUtil.createValue;
