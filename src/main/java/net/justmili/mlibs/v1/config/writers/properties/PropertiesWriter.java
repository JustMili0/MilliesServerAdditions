package net.justmili.mlibs.v1.config.writers.properties;

import net.justmili.mlibs.CoreLibs;
import net.justmili.mlibs.v1.config.entry.ConfigEntry;
import net.justmili.mlibs.v1.config.entry.ListConfigEntry;
import net.justmili.mlibs.v1.config.items.CategoryItem;
import net.justmili.mlibs.v1.config.items.CommentItem;
import net.justmili.mlibs.v1.config.items.ConfigItem;
import net.justmili.mlibs.v1.config.writers.FormatWriter;
